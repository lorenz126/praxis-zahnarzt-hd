...
export default function Functional() {
  ...
  const benefits = [
    {
      title: "Aufbissschienen",
      description:
        "Individuell angefertigte Schienen zur Behandlung von Zähneknirschen und Kieferverspannungen",
    },
    {
      title: "CMD-Therapie",
      description:
        "Behandlung von Craniomandibulären Dysfunktionen (Kiefergelenksstörungen)",
    },
    {
      title: "Schmerzlinderung",
      description:
        "Effektive Therapie bei Kopfschmerzen, Nackenverspannungen und Kieferschmerzen",
    },
    {
      title: "Funktionsanalyse",
      description:
        "Umfassende Diagnostik der Kiefergelenke und Bisslage",
    },
  ];

  const faqs = [
    {
      question: "Was ist CMD?",
      answer:
        "CMD (Craniomandibuläre Dysfunktion) bezeichnet Störungen im Kiefergelenk und der Kaumuskulatur. Symptome können Kieferschmerzen, Kopfschmerzen, Knackgeräusche oder eingeschränkte Mundöffnung sein.",
    },
    {
      question: "Wie funktioniert eine Aufbissschiene?",
      answer:
        "Die Aufbissschiene wird nachts getragen und verhindert das Aufeinanderpressen der Zähne. Sie entlastet die Kiefermuskulatur und schützt die Zähne vor Abrieb durch Knirschen.",
    },
    {
      question: "Zahlt die Krankenkasse die Aufbissschiene?",
      answer:
        "Gesetzliche Krankenkassen übernehmen die Kosten für eine Aufbissschiene bei medizinischer Notwendigkeit (z.B. diagnostizierte CMD). Private Versicherungen zahlen meist vollständig.",
    },
  ];
      ...
      <section className="bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:pl-6 lg:pr-12 pt-16 sm:pt-24 pb-12 sm:pb-16">
          ...
          <p className="mt-6 text-lg text-stone max-w-2xl">
            CMD-Therapie und Aufbissschienen bei Kiefergelenksproblemen,
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:pl-6 lg:pr-12 py-14 sm:py-20">
          <div className="rounded-2xl bg-gradient-to-br from-primary/10 to-secondary/10 p-8 sm:p-12 text-center">
            <h2 className="text-2xl sm:text-3xl font-medium text-charcoal">
              Funktionsanalyse vereinbaren
            </h2>
            <p className="mt-4 text-stone max-w-2xl mx-auto">
              Leiden Sie unter Kieferschmerzen oder Zähneknirschen? Lassen Sie
              sich beraten.
            </p>
            <div className="mt-8">
              <a
